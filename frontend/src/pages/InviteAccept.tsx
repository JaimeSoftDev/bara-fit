    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-700 via-brand-600 to-accent-600 px-4 py-10">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center text-white">
          ...
          <p className="mt-1 text-sm text-white/80">Completa tu registro para empezar.</p>
        </div>
          ...
          {invite && invite.status === "pending" && (
            <>
              <p className="mb-4 text-sm text-slate-600">
                <span className="font-medium text-slate-900">{invite.trainerName}</span> te invitó a
                unirte como cliente en BaraFit. Crea una contraseña para <b>{invite.email}</b>.
              </p>
